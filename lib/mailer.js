...
export const templates = {
  ...
  newParentForTeacher: (name, email, childrenNote) =>
    wrap('New parent registration', `<p>${name} (${email}) has registered as a parent and is awaiting approval.${childrenNote ? `<br/><br/><strong>Requested / Mentioned Children:</strong> ${childrenNote}` : ''}</p>`),
  passwordReset: (link) =>
