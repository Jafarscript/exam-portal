...
function getTransporter() {
  ...
  if (!process.env.SMTP_HOST) {
    console.warn('SMTP not configured - emails will be logged to the console instead of sent.');
    return null;
  }
...
// Fire-and-forget: email failures should never break the request that
// triggered them (e.g. an exam submission must still succeed if SMTP is down).
